...
class TestDagValidation: # classe de teste para validação dos DAGs do Airflow

    LOAD_SECOND_THRESHOLD = 2
    REQUIRED_EMAIL = "owner@test.com"
    EXPECTED_NUMBER_OF_DAGS = 7

    def test_import_dags(self, dagbag): # teste para verificar se os DAGs são importados corretamente
        """
    ...
    def test_time_import_dags(self, dagbag): # teste para verificar se os DAGs são importados dentro do tempo limite estabelecido
        """
    ...
    @pytest.mark.skip(reason="not yet added to the DAGs") # marca como teste a ser ignorado
    def test_default_args_email(self, dagbag): # teste para verificar se os DAGs possuem o e-mail de notificação necessário para alertas
        """
    ...
    #@pytest.mark.skip(reason="not yet added to the DAGs") # marca como teste a ser ignorado
    def test_default_args_retries(self, dagbag): # teste para verofocar se as dags tem o numero de retries
        """
    ...
    def test_number_of_dags(self, dagbag): # teste se tem o numro certo de dags
        """
